...
const routes: Routes = [
  ...
  { path: 'https://usine-digitale-vcard.herokuapp.com/cart', component: CartComponent },
  { path: 'https://usine-digitale-vcard.herokuapp.com/products', component: ProductsComponent },
