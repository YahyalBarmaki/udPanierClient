...
/* export const ProductsEntreprise = [
    {
        ...
        desc: " Ne vous contentez pas de vous fondre dans le réseau, de vousdémarquer et de faire une bonne première impression.Convertissez d’autres demandes de renseignements en sauvegardant vos renseignements dans un endroit où les gens passent la plupart de leur temps... leur téléphone!",
        price: 2000,
        qtite: 4,
